          ...
          <div className="relative z-10 flex items-center h-full min-h-[400px] md:min-h-[500px] px-8 md:px-16">
            ...
            >
              ...
              <Link
                ...
                className="mt-8 group inline-flex items-center gap-3 border border-amber-gold text-amber-gold px-8 py-3 text-xs tracking-[0.15em] uppercase font-medium hover:bg-amber-gold hover:text-warm-black transition-all duration-300"
              >
                Explore Collection
