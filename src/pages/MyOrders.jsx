  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen pt-20 md:pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <h1 className="text-3xl text-white font-light tracking-tight mb-10">My Orders</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-white/40 text-lg font-light mb-2">No orders yet</p>
          ...
          <div className="space-y-4">
            {orders.map((order, i) => (
              <motion.div
                ...
                className="bg-[#111] rounded-sm p-6"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                  ...
                  <p className="text-[#C9A962] text-lg font-light">${order.total_amount?.toLocaleString()}</p>
                </div>
